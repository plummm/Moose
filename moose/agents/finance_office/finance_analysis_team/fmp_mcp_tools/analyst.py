...
class AnalystMCPTools(FMPMCPTools):
    ...
    @mcp_tool()
    def get_ratings_snapshot(self, symbol: str) -> dict:
        """
        ...
        Reference: https://site.financialmodelingprep.com/developer/docs
        """
        meta = {"tool": "get_ratings_snapshot", "symbol": symbol}
        if not symbol:
            return mcp_envelope_err("symbol is required", meta=meta)
    ...
    @mcp_tool()
    def get_historical_ratings(self, symbol: str) -> dict:
        """
        ...
        Reference: https://site.financialmodelingprep.com/developer/docs
        """
        meta = {"tool": "get_historical_ratings", "symbol": symbol}
        if not symbol:
            return mcp_envelope_err("symbol is required", meta=meta)
    ...
    def get_price_target_summary(self, symbol: str) -> dict:
        ...
        Reference: https://site.financialmodelingprep.com/developer/docs
        """
        meta = {"tool": "get_price_target_summary", "symbol": symbol}
        if not symbol:
            return mcp_envelope_err("symbol is required", meta=meta)
    ...
    def get_price_target_consensus(self, symbol: str) -> dict:
        ...
        Reference: https://site.financialmodelingprep.com/developer/docs
        """
        meta = {"tool": "get_price_target_consensus", "symbol": symbol}
        if not symbol:
            return mcp_envelope_err("symbol is required", meta=meta)
    ...
    @mcp_tool()
    def get_stock_grades(self, symbol: str) -> dict:
        """
        ...
        Reference: https://site.financialmodelingprep.com/developer/docs
        """
        meta = {"tool": "get_stock_grades", "symbol": symbol}
        if not symbol:
            return mcp_envelope_err("symbol is required", meta=meta)
    ...
    @mcp_tool()
    def get_historical_stock_grades(self, symbol: str) -> dict:
        """
        ...
        Reference: https://site.financialmodelingprep.com/developer/docs
        """
        meta = {"tool": "get_historical_stock_grades", "symbol": symbol}
        if not symbol:
            return mcp_envelope_err("symbol is required", meta=meta)
    ...
    @mcp_tool()
    def get_stock_grades_summary(self, symbol: str) -> dict:
        """
        ...
        Reference: https://site.financialmodelingprep.com/developer/docs
        """
        meta = {"tool": "get_stock_grades_summary", "symbol": symbol}
        if not symbol:
            return mcp_envelope_err("symbol is required", meta=meta)
